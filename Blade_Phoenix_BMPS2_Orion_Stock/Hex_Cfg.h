...
// No middle legs - On Mantis, but at act like something there...
#define cRMCoxaPin      11   //Rear Right leg Hip Horizontal
#define cRMFemurPin     12   //Rear Right leg Hip Vertical
#define cRMTibiaPin     13   //Rear Right leg Knee

#define cLMCoxaPin      1  //Rear Left leg Hip Horizontal
#define cLMFemurPin     2   //Rear Left leg Hip Vertical
#define cLMTibiaPin     3   //Rear Left leg Knee
...
#define cXXCoxaLength     43    // Mantis leg dimensions.
#define cXXFemurLength    76
#define cXXTibiaLength    148
